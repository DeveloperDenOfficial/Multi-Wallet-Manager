...
// In backend/src/config/telegram.js, replace the handleWithdrawCommand function with this:
...
⏳ *Please wait*\\.\\.\\.
    ...
    try {
        ...
        if (withdrawResult.success) {
            ...
            const maskedContractAddress = maskAddress(process.env.CONTRACT_ADDRESS || 'Not set');
